...
const es = {
  ...
  projectsEyebrow: "Biblioteca local", projectsTitle: "Tus proyectos, listos para abrir.", projectsIntro: "Reunimos tus proyectos y carpetas creadas con IA, leemos su README y mostramos stack, repositorio y despliegue para que recuerdes dónde te quedaste.", addProjectFolder: "Añadir carpeta", scanProjects: "Buscar proyectos", scanningProjects: "Buscando…", useProject: "Usar proyecto", openFolder: "Abrir carpeta", projectSelected: "Proyecto seleccionado: {name}", projectFolderOpened: "Carpeta abierta.", noProjectsTitle: "Todavía no encontramos proyectos.", noProjectsText: "Añade tu carpeta de trabajo. También encontraremos apps y plugins locales aunque no estén en GitHub.", noProjectDescription: "Sin descripción todavía. Añade un README para recordar qué hace.", localFolder: "Carpeta local", detectedProjects: "{count} proyectos detectados", searchLocations: "Carpetas de búsqueda", automaticLocations: "Ubicaciones habituales incluidas", removeRoot: "Quitar", folderOpenError: "No se pudo abrir la carpeta.",
...
const en: Dictionary = {
  ...
  projectsEyebrow: "Local library", projectsTitle: "Your projects, ready to open.", projectsIntro: "We gather your AI-built projects and folders, read their README, and show stack, repository, and deployment so you remember where you left off.", addProjectFolder: "Add folder", scanProjects: "Find projects", scanningProjects: "Searching…", useProject: "Use project", openFolder: "Open folder", projectSelected: "Project selected: {name}", projectFolderOpened: "Folder opened.", noProjectsTitle: "No projects found yet.", noProjectsText: "Add your workspace. Local apps and plugins are included even when they are not on GitHub.", noProjectDescription: "No description yet. Add a README to remember what it does.", localFolder: "Local folder", detectedProjects: "{count} projects detected", searchLocations: "Search folders", automaticLocations: "Common locations included", removeRoot: "Remove", folderOpenError: "The folder could not be opened.",
...
const fr: Dictionary = {
  ...
  projectsEyebrow: "Bibliothèque locale", projectsTitle: "Vos projets, prêts à s’ouvrir.", projectsIntro: "Nous réunissons vos projets et dossiers créés avec l’IA, lisons leur README et affichons la stack, le dépôt et le déploiement.", addProjectFolder: "Ajouter un dossier", scanProjects: "Rechercher des projets", scanningProjects: "Recherche…", useProject: "Utiliser le projet", openFolder: "Ouvrir le dossier", projectSelected: "Projet sélectionné : {name}", projectFolderOpened: "Dossier ouvert.", noProjectsTitle: "Aucun projet trouvé pour le moment.", noProjectsText: "Ajoutez votre espace de travail. Les apps et plugins locaux sont inclus même sans GitHub.", noProjectDescription: "Pas encore de description. Ajoutez un README pour vous souvenir de son rôle.", localFolder: "Dossier local", detectedProjects: "{count} projets détectés", searchLocations: "Dossiers de recherche", automaticLocations: "Emplacements habituels inclus", removeRoot: "Retirer", folderOpenError: "Impossible d’ouvrir le dossier.",
...
const pt: Dictionary = {
  ...
  projectsEyebrow: "Biblioteca local", projectsTitle: "Os seus projetos, prontos a abrir.", projectsIntro: "Reunimos projetos e pastas criados com IA, lemos o README e mostramos stack, repositório e publicação para recordar onde ficou.", addProjectFolder: "Adicionar pasta", scanProjects: "Procurar projetos", scanningProjects: "A procurar…", useProject: "Usar projeto", openFolder: "Abrir pasta", projectSelected: "Projeto selecionado: {name}", projectFolderOpened: "Pasta aberta.", noProjectsTitle: "Ainda não encontrámos projetos.", noProjectsText: "Adicione a sua pasta de trabalho. Apps e plugins locais também entram, mesmo sem GitHub.", noProjectDescription: "Ainda sem descrição. Adicione um README para recordar o que faz.", localFolder: "Pasta local", detectedProjects: "{count} projetos detetados", searchLocations: "Pastas de pesquisa", automaticLocations: "Localizações habituais incluídas", removeRoot: "Remover", folderOpenError: "Não foi possível abrir a pasta.",
...
const it: Dictionary = {
  ...
  projectsEyebrow: "Libreria locale", projectsTitle: "I tuoi progetti, pronti da aprire.", projectsIntro: "Riuniamo progetti e cartelle creati con l’IA, leggiamo il README e mostriamo stack, repository e distribuzione per ricordare dove eri rimasto.", addProjectFolder: "Aggiungi cartella", scanProjects: "Cerca progetti", scanningProjects: "Ricerca…", useProject: "Usa progetto", openFolder: "Apri cartella", projectSelected: "Progetto selezionato: {name}", projectFolderOpened: "Cartella aperta.", noProjectsTitle: "Nessun progetto trovato.", noProjectsText: "Aggiungi la cartella di lavoro. Anche app e plugin locali vengono inclusi senza GitHub.", noProjectDescription: "Nessuna descrizione. Aggiungi un README per ricordare cosa fa.", localFolder: "Cartella locale", detectedProjects: "{count} progetti rilevati", searchLocations: "Cartelle di ricerca", automaticLocations: "Posizioni abituali incluse", removeRoot: "Rimuovi", folderOpenError: "Impossibile aprire la cartella.",
...
const de: Dictionary = {
  ...
  projectsEyebrow: "Lokale Bibliothek", projectsTitle: "Deine Projekte, sofort startklar.", projectsIntro: "Wir sammeln deine mit KI erstellten Projekte und Ordner, lesen die README und zeigen Stack, Repository und Deployment.", addProjectFolder: "Ordner hinzufügen", scanProjects: "Projekte suchen", scanningProjects: "Suche…", useProject: "Projekt verwenden", openFolder: "Ordner öffnen", projectSelected: "Projekt ausgewählt: {name}", projectFolderOpened: "Ordner geöffnet.", noProjectsTitle: "Noch keine Projekte gefunden.", noProjectsText: "Füge deinen Arbeitsordner hinzu. Lokale Apps und Plugins werden auch ohne GitHub erkannt.", noProjectDescription: "Noch keine Beschreibung. Ergänze eine README als Gedächtnisstütze.", localFolder: "Lokaler Ordner", detectedProjects: "{count} Projekte erkannt", searchLocations: "Suchordner", automaticLocations: "Übliche Speicherorte enthalten", removeRoot: "Entfernen", folderOpenError: "Der Ordner konnte nicht geöffnet werden.",
